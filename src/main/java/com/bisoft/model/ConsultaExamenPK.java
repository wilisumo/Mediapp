...
public class ConsultaExamenPK implements Serializable {
	...
	/*
	 * Porque tiene definido el criterio de unicidad hascode y equals
	 * si no tubiera hascode y equals retornaria false al estar comparando
	 * dos referencias de memoria y no dos valores.
	 * 
	a.valor = 1
    b.valor = 1
    a==b //true
